...
class WorldModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self._Qs = nn.ModuleList([layers.mlp(cfg.latent_dim + cfg.action_dim + cfg.task_dim, 2 * [cfg.mlp_dim],
    ...
    def Q(self, z, a, task, return_type='min', target=False):
        ...
        out = torch.stack([q(z) for q in Qs])
...
class OCWorldModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # TODO: initialize weights in the last linear layers of OCRewardModel and Q-models
...
class OCDynamicsModel(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        self.cfg = cfg
        # TODO: initialization code: GNN, ...

    def forward(self, slots, action):
        # TODO: predict slots after performing 'action'
...
class OCRewardModel(nn.Module):
    ...
    def forward(self, slots, action):
        # TODO: predict reward after performing 'action'
        raise NotImplementedError()
...
class OCPolicy(nn.Module):
    ...
    def forward(self, slots):
        # TODO: predicts mu and sigma for action distribution
        raise NotImplementedError()
